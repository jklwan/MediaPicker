...
public class GifHeaderParser {
    ...
    public GifHeaderParser setData(@Nullable byte[] data) {
        if (data != null) {
            ...
            rawData = null;
            header.status = com.chends.media.picker.scaleview.gifdecoder.GifDecoder.STATUS_OPEN_ERROR;
        }
        return this;
    }
    ...
    @NonNull
    public com.chends.media.picker.scaleview.gifdecoder.GifHeader parseHeader() {
        if (rawData == null) {
            ...
            switch (code) {
                case IMAGE_SEPARATOR:
                    ...
                    if (header.currentFrame == null) {
                        header.currentFrame = new com.chends.media.picker.scaleview.gifdecoder.GifFrame();
                    }
                    readBitmap();
                    break;
    ...
    private boolean err() {
        return header.status != com.chends.media.picker.scaleview.gifdecoder.GifDecoder.STATUS_OK;
    }
}
